...
export default function BlockButton({ targetId, targetAlias, initialBlocked }: BlockButtonProps) {
 ...
 return (
 <button
 className={`inline-flex min-h-[36px] cursor-pointer items-center justify-center gap-2 rounded-md border border-input bg-transparent px-8 py-2 text-sm font-semibold no-underline transition-all ${blocked ?"text-stone-500" :"text-red-700"}`}
