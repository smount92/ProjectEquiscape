                ...
                <div className="grid-cols-[repeat(auto-fill,minmax(300px,1fr))] grid gap-6 mt-6">
                    {horses.map((horse) => (
                        ...
                        >
                            ...
                            <div className="p-4">
                                <div className="text-sm font-semibold text-foreground">{horse.customName}</div>
                                <div className="mt-0.5 text-xs text-secondary-foreground">{horse.refName}</div>
            ...
            {hasMore && (
                <div className="mt-8 flex justify-center">
                    <button
                        onClick={loadMore}
                        disabled={isPending}
                        className="inline-flex min-h-[44px] cursor-pointer items-center justify-center gap-2 rounded-md border border-input bg-transparent px-8 py-2 text-sm font-semibold text-secondary-foreground no-underline transition-all hover:bg-muted disabled:opacity-50"
