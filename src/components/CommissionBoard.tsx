...
export default function CommissionBoard({ commissions }: { commissions: Commission[] }) {
 ...
 <div
 key={c.id}
 className="border-input flex flex-col rounded-lg border bg-[var(--muted)] p-6 transition-all hover:-translate-y-[1px] hover:border-forest/30"
 >
 ...
 <>
 <button
 className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-md border-0 bg-forest px-2 py-1 text-xs font-semibold text-white no-underline shadow-sm transition-all"
