...
export default function Footer() {
    ...
    return (
        <footer className="mt-auto border-t border-[rgba(139,90,43,0.2)] bg-[#3B2A1A] pt-16 px-8 text-sm text-white/70">
            <div className="flex justify-between gap-16 max-w-[var(--max-width)] mx-auto pb-12 max-md:flex-col max-md:gap-2xl">
                {/* Brand */}
                ...
                {/* Links */}
                <div className="flex gap-16 max-md:justify-center max-md:gap-2xl max-md:flex-wrap">
            ...
            {/* Bottom bar */}
            <div className="flex items-center justify-between max-w-[var(--max-width)] mx-auto py-6 border-t border-white/10 text-xs text-white/40 max-md:flex-col max-md:gap-sm max-md:text-center">
