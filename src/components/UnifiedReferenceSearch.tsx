            ...
            {selectedItem && selectedCatalogId && releases.length === 0 ? (
                ...
                <>
                    ...
                    {releases.length > 0 && selectedItem && selectedItem.itemType === "plastic_mold" && (
                        <div className="border-edge bg-bg-card border-edge animate-fade-in-up mt-4 overflow-hidden rounded-lg border p-12 shadow-md transition-all max-[480px]:rounded-[var(--radius-md)]">
