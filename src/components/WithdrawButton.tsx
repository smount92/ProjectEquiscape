...
export default function WithdrawButton({ entryId }: { entryId: string }) {
 ...
 return (
 <button
 className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-md border border-input bg-transparent px-2 py-[2px] text-xs font-semibold text-[var(--destructive)] no-underline transition-all"
