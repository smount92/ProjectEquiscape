            ...
            <div className="min-h-[calc(100vh - var(--header max-sm:px-4-height))] px-8-inner animate-fade-in-up py-[var(--space-3xl)] max-sm:py-[0]">
                ...
                <section className="mb-[var(--space-3xl)]">
                    ...
                    <p>
                        ...
                        these Terms of Service. If you do not agree, please do not use the Platform. We may update these
                        terms from time to time, and continued use constitutes acceptance of any changes.
                    </p>
                </section>
                ...
                <section className="mb-[var(--space-3xl)]">
                    ...
                    <p>
                        ...
                        that you have your parent or guardian&apos;s permission to use the Platform. Model Horse Hub is
                        intended for personal, non-commercial collection management and hobby community use.
                    </p>
                </section>
                ...
                <section className="mb-[var(--space-3xl)]">
                    ...
                    <p className="mt-4">
                        Your display alias must not impersonate another person, use offensive language, or violate the
                        rights of others.
                    </p>
                </section>
                ...
                <section className="mb-[var(--space-3xl)]">
                    ...
                    <p>
                        ...
                        descriptions, and collection data. By making content public (e.g., sharing a horse in the Show
                    ...
                    <p className="mt-4">We reserve the right to remove content that violates these guidelines.</p>
                </section>
                ...
                <section className="mb-[var(--space-3xl)]">
                    ...
                    <ul className="m-[0 0 var(--space-lg) 0] list-none p-0">
                        <li>
                            ...
                            handle, hold, or process money.
                        </li>
                        <li>
                            <strong>We are not a party to transactions.</strong> When you buy or sell a model, the
                            transaction is between you and the other user. We provide tools to coordinate, but we are
                            not responsible for the outcome.
                        </li>
                        <li>
                            <strong>Use good judgment.</strong> We provide safety features like off-platform payment
                            warnings and rug-pull protection, but ultimately you are responsible for verifying the
                ...
                <section className="mb-[var(--space-3xl)]">
                    ...
                    <p>
                        ...
                        intellectual property of Model Horse Hub. Reference data (mold names, release names,
                ...
                <section className="mb-[var(--space-3xl)]">
                    ...
                    <ul className="m-[0 0 var(--space-lg) 0] list-none p-0">
                        ...
                        <li>
                            We do not guarantee the accuracy of reference data, market prices, or AI-generated mold
                            identifications. These are provided as helpful tools, not authoritative sources.
                        </li>
                        <li>
                            We are not responsible for losses resulting from transactions between users, including
                            fraud, misrepresentation, or shipping damage.
                        </li>
                        <li>
                            We may experience downtime for maintenance or updates. We will make reasonable efforts to
                            minimize disruption.
                        </li>
                        <li>
