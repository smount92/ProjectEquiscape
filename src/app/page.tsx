...
export default function LandingPage() {
    return (
        <div className="overflow-x-hidden">
                ...
                <div className="mx-auto max-w-[var(--max-width)] text-center">
                    ...
                    <div className="grid-cols-[repeat(auto-fit, minmax(300px, 1fr))] grid gap-8">
                        ...
                        >
                            ...
                            <h3 className="bg-bg-card border-edge border-edge overflow-hidden-title relative rounded-lg border p-12 text-left shadow-md transition-all max-[480px]:rounded-[var(--radius-md)]">
                                10,500+ Reference Releases
                            </h3>
                            <p className="bg-bg-card border-edge border-edge overflow-hidden-desc relative rounded-lg border p-12 text-left shadow-md transition-all max-[480px]:rounded-[var(--radius-md)]">
                        ...
                        <div
                            ...
                            id="feature-social"
                        >
                            <div className="text-forest feature-icon-social mb-6 flex h-[56px] w-[56px] items-center justify-center rounded-md bg-[var(--color-accent-primary-glow)]">
                                <svg
                                    width="32"
                                    height="32"
                                    viewBox="0 0 24 24"
                        ...
                        <div
                            ...
                            id="feature-shows"
                        >
                            <div className="text-forest feature-icon-shows mb-6 flex h-[56px] w-[56px] items-center justify-center rounded-md bg-[var(--color-accent-primary-glow)]">
                                <svg
                                    width="32"
                                    height="32"
                                    viewBox="0 0 24 24"
                        ...
                        >
                            <div className="text-forest feature-icon-market mb-6 flex h-[56px] w-[56px] items-center justify-center rounded-md bg-[var(--color-accent-primary-glow)]">
                                <svg
                                    width="32"
                                    height="32"
                                    viewBox="0 0 24 24"
            ...
            {/* ─── Social Proof / Stats ─── */}
            <section
                className="border-edge border-edge border-t border-b bg-[var(--color-bg-secondary)] px-8 py-[var(--space-3xl)]"
                id="stats"
            >
