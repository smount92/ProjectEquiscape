    ...
    if (showSuccess) {
        return (
            <div className="success-overlay">
                <div className="bg-card border-edge animate-fade-in-up max-w-[480px] rounded-lg border p-12 p-[var(--space-3xl)] text-center shadow-md transition-all max-[480px]:rounded-[var(--radius-md)]">
          ...
          ================================================================ */}
            {currentStep === 3 && (
                <div className="step-content" key="step-3">
                    ...
                    <div className="bg-bg-card border-edge border-[rgba(44, 85, 69, 0.2)] relative overflow-hidden overflow-visible rounded-lg border p-12 shadow-md transition-all max-[480px]:rounded-[var(--radius-md)]">
                        {/* Vault Header */}
