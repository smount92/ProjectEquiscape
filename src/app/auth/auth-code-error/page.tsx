        ...
        >
            <div className="flex flex-col items-center justify-center pt-4 pb-8">
                ...
                <div className="flex w-full flex-col gap-3 sm:max-w-xs">
                    ...
                    <Link
                        href="/login"
                        className="inline-flex min-h-[40px] items-center justify-center gap-2 rounded-xl border border-input bg-card px-8 py-2 text-sm font-semibold text-secondary-foreground transition-all hover:bg-muted hover:text-foreground"
                        id="go-to-login"
                    >
                        Back to Sign In
                    </Link>
