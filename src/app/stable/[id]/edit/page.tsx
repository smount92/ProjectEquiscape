    ...
    return (
        <div className="mx-auto max-w-[var(--max-width)] px-6 px-[0] py-12 py-[0]">
            ...
            <div className="animate-fade-in-up mx-auto max-w-[680px] px-[0] py-12">
                ...
                <div className="bg-bg-card border-edge border-edge relative mb-8 overflow-hidden rounded-lg border p-12 shadow-md transition-all max-[480px]:rounded-[var(--radius-md)]">
