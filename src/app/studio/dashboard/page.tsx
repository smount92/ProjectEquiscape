...
export default async function StudioDashboardPage() {
    ...
    return (
        <div className="max-w-[var(--max-width)] mx-auto py-[0] px-6">
            {/* Header */}
            <div className="py-8 px-6 rounded-lg bg-[linear-gradient(135deg,rgba(139,92,246,0.08),rgba(236,72,153,0.06))] border border-[rgba(139,92,246,0.15)] animate-fade-in-up mb-8">
                <div className="max-w-[800px]">
                    <div className="justify-between gap-4" style={{ display: "flex", alignItems: "center", flexWrap: "wrap" }}>
                        <div>
                            <h1 className="text-[calc(1.5rem*var(--font-scale))] m-0" >
                    ...
                    <div className="flex gap-6 mt-6 pt-6 border-t border-[rgba(0,0,0,0.06)] flex-wrap">
                        ...
                        <div className="flex flex-col items-center gap-[2px]">
                            <span className={`studio-status-badge status-${profile.status} text-[calc(0.75rem*var(--font-scale))]`}>
