            ...
            <div className="grid-cols-[1fr 420px] animate-fade-in-up grid items-stretch gap-[0] overflow-hidden rounded-lg shadow-lg">
                ...
                <div className="flex min-h-[100%] flex-col gap-2 bg-[#C8B596] px-6 py-8">
                    ...
                    {horse.trade_status === "Stolen/Missing" && (
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="m-[4px 0 0] text-muted text-[calc(0.8rem*var(--font-scale))]">
                    ...
                    <Link
                        ...
                        className="p-[6px 14px 6px 6px] bg-bg-card border-edge border-edge text-ink inline-flex w-fit items-center gap-1 rounded-full rounded-lg border p-12 text-sm font-semibold no-underline shadow-md transition-all max-[480px]:rounded-[var(--radius-md)]"
                    >
                        ...
                        {isOwnHorse && (
                            <span className="bg-forest inline-flex rounded-sm px-2 py-[2px] text-[calc(0.65rem*var(--font-scale))] font-bold tracking-wider text-white uppercase">
                                You
                            </span>
                        )}
                    </Link>
                    ...
                    <div className="passport-detail-bg-card border-edge rounded-lg border p-12 shadow-md transition-all max-[480px]:rounded-[var(--radius-md)]">
                        ...
                        {refInfo ? (
                            ...
                            <div className="border-[rgba(255, 255, 255, 0.04)] flex items-center justify-between border-b px-[0] py-[5px]">
                                ...
                                <span
                                    className="text-ink max-w-[60%] text-right text-[calc(0.8rem*var(--font-scale))] font-semibold"
                                    style={{ opacity: 0.6, fontStyle: "italic" }}
                                >
