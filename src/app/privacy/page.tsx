...
export const metadata: Metadata = {
    ...
    description:
        "How Model Horse Hub collects, uses, and protects your data. Privacy-first by design.",
};
            ...
            <div className="static-page-inner animate-fade-in-up">
                ...
                <section className="static-section">
                    ...
                    <p>
                        ...
                        data, financial information, and personal details belong to <strong>you</strong> &mdash;
                        not us, not advertisers, and not &ldquo;partner companies.&rdquo; We designed every layer
                        of this platform with privacy as a core architectural principle, not an afterthought.
                    </p>
                </section>
                ...
                <section className="static-section">
                    ...
                    <p>
                        ...
                        display <strong>alias</strong> (username) of your choosing. We do not require your
                        real name, mailing address, phone number, or any government ID.
                    </p>

                    <h3>Collection Data</h3>
                    <p>
                        Information you voluntarily enter about your model horses, including custom names,
                        condition grades, finish types, photos, and reference links to our catalog database.
                        This data is stored under your account and protected by row-level security.
                    </p>

                    <h3>Financial Vault Data</h3>
                    <p>
                        Purchase prices, estimated values, insurance notes, and purchase dates you optionally
                        provide. This data is <strong>encrypted at rest</strong> and accessible only to you.
                        Our team cannot view your financial vault &mdash; it is protected by cryptographic
                        row-level security policies that enforce access at the database level.
                    </p>

                    <h3>Photos</h3>
                    <p>
                        Images you upload are stored in secure cloud storage with signed URL access controls.
                        Photos are only accessible via time-limited signed URLs &mdash; they cannot be
                        hotlinked or scraped by third parties.
                    </p>

                    <h3>Usage Data</h3>
                    <p>
                        We use Google Analytics to understand aggregate usage patterns (page views, feature
                        adoption). This data is anonymized and never linked to your collection or financial
                        information.
                    </p>
                </section>
                ...
                <section className="static-section">
                    ...
                    <ul className="list-none p-0 m-[0 0 var(--space-lg) 0]">
                        <li>
                            ...
                            refuse to return another user&apos;s data
                        </li>
                        <li>
                            <strong>Encrypted connections</strong> &mdash; all data in transit is encrypted
                            via TLS/HTTPS
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Secure authentication</strong> &mdash; powered by Supabase Auth with
                            PKCE flow and HTTP-only session cookies
                        </li>
                        <li>
                            <strong>Rate limiting</strong> &mdash; sensitive actions are protected against
                ...
                <section className="static-section">
                    ...
                    <ul className="list-none p-0 m-[0 0 var(--space-lg) 0]">
                        <li>
                            ...
                            the Show Ring. Financial data is <em>never</em> shown publicly.
                        </li>
                        <li>
                            <strong>Hoofprint&trade; transfers</strong> &mdash; when you transfer a horse
                            to another user, provenance records (ownership dates, show results) transfer
                            with the horse. Financial vault data is <em>never</em> transferred.
                        </li>
                        <li>
                            <strong>Commerce</strong> &mdash; when you engage in a Safe-Trade transaction,
                            the other party can see the horse listing details you&apos;ve published. No
                            private data is shared.
                        </li>
                        <li>
                            <strong>Legal requirements</strong> &mdash; if required by law, subpoena, or
                            court order. We will notify you unless legally prohibited from doing so.
                        </li>
                    </ul>
                </section>
                ...
                <section className="static-section">
                    ...
                    <ul className="list-none p-0 m-[0 0 var(--space-lg) 0]">
                        ...
                        <li><strong>Opt out of analytics</strong> &mdash; use any standard ad-blocker or Do Not Track setting</li>
                    </ul>
                </section>
                ...
                <section className="static-section">
                    ...
                    <p>
                        ...
                        management. We do not use tracking cookies, advertising cookies, or third-party
                        marketing pixels. The only non-essential cookie is from Google Analytics, which
                ...
                <section className="static-section">
                    ...
                    <p>
                        ...
                        account, please <Link href="/contact">contact us</Link> and we will promptly delete
                        the account.
                    </p>
                </section>
                ...
                <section className="static-section">
                    ...
                    <p>
                        ...
                        of any material changes via email. The &ldquo;Last updated&rdquo; date at the top of
                ...
                <section className="static-section">
                    ...
                    <p>
                        ...
                        please reach out via our <Link href="/contact">Contact page</Link>.
                    </p>
                </section>
            </div>
        </div>
