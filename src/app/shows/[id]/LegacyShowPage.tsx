/**
 * THE LEGACY events-based show page — extracted verbatim from
 * /shows/[id]/page.tsx at the Phase E2 cutover. The route is now a
 * resolver (see page.tsx): v2 show ids render the v2 public page;
 * everything else falls through here unchanged. This file retires
 * with the legacy show system.
 */
...
export default async function LegacyShowPage({ showId }: { showId: string }) {
